...
export interface Params {
  ...
  idleTrafficRefBpsPerMem: string;
  idleTrafficFloorBps: string;
}
...
function createBaseParams(): Params {
  return {
    ...
    trustMinServes: "0",
    trustMaxRateBps: "0",
    idleTrafficRefBpsPerMem: "0",
    idleTrafficFloorBps: "0",
  };
}
...
export const Params: MessageFns<Params> = {
  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.idleTrafficRefBpsPerMem !== "0") {
      writer.uint32(200).uint64(message.idleTrafficRefBpsPerMem);
    }
    if (message.idleTrafficFloorBps !== "0") {
      writer.uint32(208).uint64(message.idleTrafficFloorBps);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 25: {
          ...
          message.idleTrafficRefBpsPerMem = reader.uint64().toString();
          continue;
        }
        case 26: {
          if (tag !== 208) {
          ...
          message.idleTrafficFloorBps = reader.uint64().toString();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): Params {
    return {
      ...
      trustMaxRateBps: isSet(object.trustMaxRateBps)
        ...
        : "0",
      idleTrafficRefBpsPerMem: isSet(object.idleTrafficRefBpsPerMem)
        ? globalThis.String(object.idleTrafficRefBpsPerMem)
        : isSet(object.idle_traffic_ref_bps_per_mem)
        ? globalThis.String(object.idle_traffic_ref_bps_per_mem)
        : "0",
      idleTrafficFloorBps: isSet(object.idleTrafficFloorBps)
        ? globalThis.String(object.idleTrafficFloorBps)
        : isSet(object.idle_traffic_floor_bps)
        ? globalThis.String(object.idle_traffic_floor_bps)
        : "0",
    };
  },
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.idleTrafficRefBpsPerMem !== "0") {
      obj.idleTrafficRefBpsPerMem = message.idleTrafficRefBpsPerMem;
    }
    if (message.idleTrafficFloorBps !== "0") {
      obj.idleTrafficFloorBps = message.idleTrafficFloorBps;
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<Params>, I>>(object: I): Params {
    ...
    message.idleTrafficRefBpsPerMem = object.idleTrafficRefBpsPerMem ?? "0";
    message.idleTrafficFloorBps = object.idleTrafficFloorBps ?? "0";
    return message;
  },
};
